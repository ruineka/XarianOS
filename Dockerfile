...
RUN echo -e "[multilib]\nInclude = /etc/pacman.d/mirrorlist\n" >> /etc/pacman.conf && \
	...
	pacman --noconfirm -S arch-install-scripts btrfs-progs pyalpm sudo reflector python-markdown-it-py wget xcb-util-wm fmt python-wheel python-build python-installer python-setuptools && \
